...
A few checks are in place to try to prevent this happening, such as if package.json can't be parsed or the 'main' file doesn't exist.  If you clicked run and nothing happens, it's likely the nw.exe process is running and you'll have to kill it manually in Task Manager
